...
# jacobian_null = sym.nsimplify(jacobian_null, tolerance=1e-4, rational=True)
# Hessian = sym.nsimplify(Hessian, tolerance=1e-4, rational=True)
...
# print("start saving func")
# dill.settings['recurse'] = True
# dill.dump(J_func, open("J_func_simple", "wb"))
# dill.dump(H_func, open("H_func_simple", "wb"))
# print("finshed saving func")
