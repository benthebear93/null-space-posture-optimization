...
class OptimalIK(Tx90):
    def __init__(self, time_step, accuracy, max_iteration):
        ...
        self.c = np.array([0.0001, 0.0001, 0.0001, 0.0001, 0.0001])   # Tikhonov # 0.1
    ...
    def null_space_method(self, posCount, q0, p_goal):
        ...
        while True:
            ...
            time_st = endt-st
            q_dot = (
                2.9* psd_J @ t_dot + 1.5 * psd_J@t_dot + 1.55 *psd_J @(temp-t_dot) - self.Kn_ * (np.eye(7) - (psd_J @ J_na)) @ gH
