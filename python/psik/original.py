...
Ktheta = np.diag(np.array([1.72, 1.32, 0.52, 0.3, 0.3 ,0.3])) # 3x3 
...
def null_space_method(q0, p_goal, weights=[1,3,1], time_step=0.01, max_iteration=5000, accuracy=0.01):
    ...
    while True:
        ...
        if t_dot[0][0] < accuracy and t_dot[1][0] < accuracy and t_dot[2][0] < accuracy and t_dot[3][0] < accuracy and t_dot[4][0] < accuracy: 
            break
